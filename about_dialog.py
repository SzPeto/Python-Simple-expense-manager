from PyQt5.QtWidgets import QDialog, QVBoxLayout, QPlainTextEdit, QTextEdit, QTextBrowser
    ...
    def __init__(self):
        ...
        self.about_text = ("""
            ...
            <p>&nbsp;• You can sort by any column by simply clicking the column name, clicking multiple times<br>
               ...
               &nbsp;&nbsp;&nbsp;&nbsp;save the new value<br><br> 
            If you encounter any issues related to this app, please report them via : <b><i>szpeto12@gmail.com</i></b><br>
            ...
            You can do it via <a href="https://www.paypal.me/szpeto">support me</a> button, or IBAN account transfer.<br>
